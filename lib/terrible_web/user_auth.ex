defmodule TerribleWeb.UserAuth do
  ...
  """
  @spec log_in_user(Plug.Conn.t(), Terrible.Identity.Schemas.User.t(), map()) :: Plug.Conn.t()
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      TerribleWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule TerribleWeb.PageLive do
        use TerribleWeb, :live_view

        on_mount {TerribleWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{TerribleWeb.UserAuth, :ensure_authenticated}] do
